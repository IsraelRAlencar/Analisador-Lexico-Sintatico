...
Token* Scanner::nextToken() {
    while (pos < input.length()) {
        ...
        if (isalpha(current)) {
            ...
            if (lexeme == "int") return new Token(INT_TYPE, lexeme);
            if (lexeme == "char") return new Token(CHAR_TYPE, lexeme);
            if (lexeme == "if") return new Token(IF, lexeme);
            if (lexeme == "else") return new Token(ELSE, lexeme);
            if (lexeme == "while") return new Token(WHILE, lexeme);
            if (lexeme == "for") return new Token(FOR, lexeme);
            if (lexeme == "return") return new Token(RETURN, lexeme);
            if (lexeme == "void") return new Token(VOID, lexeme);
